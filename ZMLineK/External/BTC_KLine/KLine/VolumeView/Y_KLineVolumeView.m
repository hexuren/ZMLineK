...
- (void)drawVolumeLine
{
    ...
    [self.needDrawKLineVolumePositionModels enumerateObjectsUsingBlock:^(Y_KLineVolumePositionModel * _Nonnull volumePositionModel, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        CGRect volumeFrame = CGRectMake(volumePositionModel.StartPoint.x-2.5, volumePositionModel.StartPoint.y,  [Y_StockChartGlobalVariable kLineWidth], CGRectGetHeight(self.frame) - volumePositionModel.StartPoint.y);
