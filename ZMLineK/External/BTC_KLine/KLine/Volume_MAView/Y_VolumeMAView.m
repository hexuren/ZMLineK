...
-(void)maProfileWithModel:(Y_KLineModel *)model
{
    ...
    _volumeDescLabel.text = [NSString stringWithFormat:@" %@(7,30):%@",@"成交量",[CommonMethod calculateWithRoundingMode:NSRoundPlain roundingValue:(double)model.Volume afterPoint:model.coin]];
